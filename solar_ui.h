...
public:
    ...
    // Apply space exploration theme to Dear ImGui
    ...
    void renderSpaceshipHUD(float screenWidth, float screenHeight, Spaceship& ship, CameraController& cam, const CelestialDatabase& db) {
    ...
    void renderMissionHUDTracker(float screenWidth, float screenHeight, MissionSystem& missions, Spaceship& ship, CameraController& cam) {
        if (cam.photoModeActive) return;
    ...
    void renderMissionModal(float screenWidth, float screenHeight, MissionSystem& missions, Spaceship& ship, CameraController& cam) {
